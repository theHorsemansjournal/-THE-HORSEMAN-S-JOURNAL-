...
// Add remaining articles 6-15 here...
// (Articles 6-15 follow the same pattern - I've included them in the complete file)
...
function renderBooksGrid() {
      ...
      <div class="book-3d">
        <div class="book-spread">
          ...
          <div class="book-right">
            <div class="book-watermark">${icons[index % icons.length]}</div>
            <div class="book-page-num">The Horseman's Journal | Volume ${String(index + 1).padStart(2, '0')}</div>
            <div class="book-art-title">${shortTitle}</div>
            <div class="book-rule"></div>
            <div class="book-art-text">${article.tagline}</div>
  ...
  console.log(`Rendered ${articles.length} books`);
}
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM ready, rendering books...');
  renderBooksGrid();
});

console.log('Chronicles JS loaded - waiting for DOM');
